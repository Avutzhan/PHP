...
include_once("Classes/TextInput.php");
include_once("Classes/PlainTextFilter.php");
include_once("Classes/MarkdownFormat.php");
include_once("Classes/DangerousHTMLTagsFilter.php");
