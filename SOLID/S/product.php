...
//На данном этапе тут не используется SRP
//так как в классе есть две функции (обязанности)
// одна меняет свойства класса другая это логика логирования
//То есть мы можем захотеть поменять способ сохранения в бд
// или же логику логирования в обоих случаях придется лесть в этот класс и менять его
